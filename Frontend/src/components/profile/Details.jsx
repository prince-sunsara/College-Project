    ...
    return (
        <Box className="mt-8 ml-5">
            ...
            <Box className="flex flex-col justify-between w-[60%]">
                <InputBox>
                    <label>Name </label>
                    <TextField className='bg-white rounded' size="small" value={userData.name} />
                </InputBox>
                <InputBox>
                    <label>Email </label>
                    <TextField className='bg-white rounded' size="small" value={userData.email} />
                </InputBox>
                <InputBox>
                    <label>Phone </label>
                    <TextField className='bg-white rounded' size="small" value={userData.phone} />
                </InputBox>
                <InputBox>
